...
- **Bindings CLI** — D1, R2, KV, Hyperdrive, Workers AI, Vectorize, Queues, Durable Objects, Workflows, cron, secrets, vars, Access, Flagship, Logpush, Web Analytics, Email, Images, Stream, Media
